      ...
      <div className="results-content">
        ...
        <div style={{ padding: '1.5rem', borderRadius: '8px', background: isSynthetic ? 'var(--danger-bg)' : 'var(--success-bg)', border: `1px solid ${isSynthetic ? 'var(--danger-text)' : 'var(--success-text)'}` }}>
          <h2 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: isSynthetic ? 'var(--danger-text)' : 'var(--success-text)', marginBottom: '0.5rem' }}>
            ...
            {isSynthetic ? "This image appears to be AI-Generated or Manipulated." : "This image appears to be Authentic."}
          </h2>
          <p style={{ color: 'var(--text-primary)', fontSize: '0.95rem', lineHeight: 1.5 }}>
            {isSynthetic 
              ? "Our analysis detected patterns consistent with artificial generation or significant digital manipulation. This could mean the image was created by an AI tool (like Midjourney or DALL-E) or heavily edited."
              : "We found no significant traces of AI generation or heavy digital tampering. The image's internal structure and metadata look consistent with a standard photograph."}
          </p>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                  Image Format: <strong>{meta.format}</strong> &nbsp; | &nbsp; Resolution: <strong>{meta.dimensions}</strong>
                </p>
              </div>
            </div>
